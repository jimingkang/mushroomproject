...
class Load:
    def __init__(self, Input, opt, Batch=False):
        ...
        self.cfg ={
            ...
            'Detector':{
                'Classes': ['muhsroom', 'car', 'umbrella', 'truck', 'motorcycle', 'bicycle', 'bus'],
                'Confidence' : {'muhsroom' :.1, 'car':.35, 'umbrella':.4, 'truck':.2, 'motorcycle':.2, 'bicycle':.5, 'bus':.1},
    ...
    def Run(self):
        ...
        for frame, frame_read in tqdm(iter(Stream), desc='Processing', ncols=100, unit=' Frame'):
            ...
            for det in Detections:
                ...
                if c in ['car','bus', 'truck','motorcycle','muhsroom']:
