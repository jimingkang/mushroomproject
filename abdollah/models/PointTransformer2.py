...
class PointTransformerModel(pl.LightningModule):
    def __init__(self, num_predictions=100, lr=1e-4, rgb=False, rotation = "6D",):
        ...
        match self.rotation:
            ...
            case "9D":
                self.rotation_dims = 9  # Predict rotations (6D representation)
            case "quat":
                self.rotation_dims = 4  # Predict rotations (6D representation)
            case "euler":
                self.rotation_dims = 3  # Predict rotations (6D representation)
