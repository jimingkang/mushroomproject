...
def print_hi(name):
    ...
    hi.get_scara_param()
    print(hi.x,hi.y)
    ret=hi.movel_xyz(hi.x,hi.y,0,55,20)
    #ret=hi.new_movej_xyz_lr(hi.x,hi.y,0,55,20,0,1)
    hi.wait_stop()
    print(ret)
    ...
    while i<4:
        ...
        hi.get_scara_param()
        print(hi.x,hi.y)
        rett=hi.movel_xyz(hi.x-i*20,hi.y-i*20,-80,75,20)
        print(rett)
        hi.wait_stop()
        hi.get_scara_param()
        print(hi.x,hi.y)
        hi.movel_xyz(hi.x+i*20,hi.y+i*20,0,75,20)
        hi.wait_stop()
