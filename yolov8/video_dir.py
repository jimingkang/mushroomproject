...
def move_increase_y(angle):
	...
	if Current_y > Ymax:
		Current_y = Ymax
	kit.servo[14].angle=Current_y
	kit.servo[12].angle=Current_y
	kit.servo[13].angle=Current_y
	kit.servo[4].angle=Current_y
	kit.servo[7].angle=Current_y
	kit.servo[8].angle=Current_y
