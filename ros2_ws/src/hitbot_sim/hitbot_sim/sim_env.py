...
from constants import DT, XML_DIR, START_ARM_POSE, START_ARM_POSE_A1_SINGLE
from constants import PUPPET_GRIPPER_POSITION_UNNORMALIZE_FN, A1_GRIPPER_POSITION_UNNORMALIZE_FN
from constants import MASTER_GRIPPER_POSITION_NORMALIZE_FN
from constants import PUPPET_GRIPPER_POSITION_NORMALIZE_FN, A1_GRIPPER_POSITION_NORMALIZE_FN
from constants import PUPPET_GRIPPER_VELOCITY_NORMALIZE_FN, A1_GRIPPER_VELOCITY_NORMALIZE_FN
...
class SingleA1Task(base.Task):
    ...
    def before_step(self, action, physics):
        right_arm_action = action[:3]  #6 jimmy
        normalized_gripper_action = action[3] #6 jimmy
...
class PickNPlaceTask(SingleA1Task):
    ...
    def get_reward(self, physics):
        ...
        touch_gripper = ("red_box", "a1_right/a1_8_gripper_finger_touch_right") in all_contact_pairs
